...
public class PlaylistDatabaseTable extends SQLiteOpenHelper  {
	...
	private static PlaylistDatabaseTable mInstance = null;
...
//			"life", "news", "science", "social", "travelling", "world" };
	...
	private PlaylistDatabaseTable(Context context) {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	  ...
	  public static PlaylistDatabaseTable getInstance(Context ctx) {

		    // Use the application context, which will ensure that you 
		    // don't accidentally leak an Activity's context.
		    // See this article for more information: http://bit.ly/6LRzfx
		    if (mInstance == null) {
		      mInstance = new PlaylistDatabaseTable(ctx);
		    }
