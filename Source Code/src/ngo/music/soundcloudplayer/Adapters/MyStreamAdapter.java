...
public class MyStreamAdapter extends SoundCloudExploreAdapter implements Constants {
	...
	public MyStreamAdapter(Context context, int resource, ArrayList<Song> onlineSongs, ApiWrapper wrapper) {
