...
import ngo.music.player.adapters.SCFollowAdapter;
...
public class SCUserSearchFragment extends Fragment {
...
//		}
	 ...
	 *
	 */
	private class loadSCUserSearchBackground extends AsyncTask<String, String, ArrayList<User>> {
		ArrayList<User> users = new ArrayList<User>();
